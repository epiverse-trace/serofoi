...
m1_cha <- run_seromodel(seroprev_data = chagas2012p,
                             seromodel_name = "constant_foi_bi",
                             n_iters = 500, 
                             n_thin = 2)

m2_cha <- run_seromodel(seroprev_data = chagas2012p,
                             seromodel_name = "continuous_foi_normal_bi",
                             n_iters = 1500, 
                             n_thin = 2)
...
m1_veev <- run_seromodel(seroprev_data = veev2012p,
                              seromodel_name = "constant_foi_bi",
                              n_iters = 500, 
                              n_thin = 2)

m2_veev <- run_seromodel(seroprev_data = veev2012p,
                              seromodel_name = "continuous_foi_normal_bi",
                              n_iters = 500, 
                              n_thin = 2)

m3_veev <- run_seromodel(seroprev_data = veev2012p,
                              seromodel_name = "continuous_foi_normal_log",
                              n_iters = 500, 
                              n_thin = 2)
```
...
mod1_chik <- run_seromodel(seroprev_data = chik2015p,
                                seromodel_name = "constant_foi_bi",
                                n_iters = 1000, 
                                n_thin = 2)

mod2_chik <- run_seromodel(seroprev_data = chik2015p,
                                seromodel_name = "continuous_foi_normal_bi",
                                n_iters = 1500, 
                                n_thin = 2)

mod3_chik <- run_seromodel(seroprev_data = chik2015p,
                     seromodel_name = "continuous_foi_normal_log",
                     n_iters = 1500, 
                     n_thin = 2)
```
