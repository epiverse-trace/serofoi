...
We now simulate a serosurvey with these historical FOIs; we make the sample sizes larger to be able to clearly visualise the patterns in seropositivity.
```{r}
sample_size <- 50
survey_features <- data.frame(
  age_min = seq(1, max_age, 1),
