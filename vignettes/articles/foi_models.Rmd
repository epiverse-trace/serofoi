...
A common criterion to decide what model fits the data the best is to choose the one with the larger `elpd`. According to this criterion, in this case the best model is the fast-epidemic model, although the regular epidemic model follows it closely (see the second row of panels B and C in Figure 4).
