...
For force-of-infection (FOI) that is constant over time, denoted $lambda$, we modelled seroprevalence for age $a$ in year $t$  (i.e. the time when the serosurvey occurred) as:
...
The corresponding code for the tympe-varing FOI model is: 
