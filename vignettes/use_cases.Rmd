...
## Case study 3. Epidemic of Chikungunya in Brazil

Chikungunya outbreaks ocurred rapidly after introduction to Brazil in 2014. We use the dataset from [@cunha2017] that conducts a serosurvey for IgG against Chikungunya virus (CHIKV) in rural area in Brazil in April 2016, right after a large CHIKV epidemic that occurred in that area 2015.

```{r data_veev, include = TRUE, errors = FALSE, warning = FALSE, message = FALSE }

chik2016 <- readRDS("../data/veev2012.RDS")
head(veev2012, 5)
