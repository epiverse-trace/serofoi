...
Based on the data and analysis shown in [@Cucunubá2017], we use one of the datasets for measuring the sero-prevalence of IgG antibodies against *Trypanosoma cruzi* infection in rural area of Colombia in 2012. The dataset is part of the serofoi package as `chagas2007`.

```{r data_chagas, include = TRUE, errors = FALSE, warning = FALSE, message = FALSE }
chagas2007 <- readRDS("../data/chagas2009.RDS") # This can be removed once data is incorporated
chagas2007 <- chagas2007 %>% filter(age_min < 45)
head(chagas2007, 5)
...
chik2016 <- readRDS("../data/chik2016.RDS")
head(chik2016, 5)
