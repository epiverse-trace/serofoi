...
namespace model_constant_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in 'constant', line 10, column 3 to column 33)",
                                                      " (in 'constant', line 13, column 2 to column 15)",
                                                      " (in 'constant', line 14, column 2 to column 30)",
                                                      " (in 'constant', line 15, column 2 to column 23)",
                                                      " (in 'constant', line 18, column 3 to column 20)",
                                                      " (in 'constant', line 17, column 19 to line 19, column 4)",
                                                      " (in 'constant', line 17, column 1 to line 19, column 4)",
                                                      " (in 'constant', line 22, column 3 to column 61)",
                                                      " (in 'constant', line 23, column 3 to column 40)",
                                                      " (in 'constant', line 21, column 18 to line 24, column 2)",
                                                      " (in 'constant', line 21, column 1 to line 24, column 2)",
                                                      " (in 'constant', line 33, column 2 to column 24)",
                                                      " (in 'constant', line 34, column 2 to column 21)",
                                                      " (in 'constant', line 35, column 2 to column 29)",
                                                      " (in 'constant', line 37, column 4 to column 48)",
                                                      " (in 'constant', line 38, column 4 to column 39)",
                                                      " (in 'constant', line 39, column 4 to column 64)",
                                                      " (in 'constant', line 36, column 18 to line 40, column 3)",
                                                      " (in 'constant', line 36, column 2 to line 40, column 3)",
                                                      " (in 'constant', line 28, column 3 to column 40)",
                                                      " (in 'constant', line 27, column 2 to line 28, column 40)",
                                                      " (in 'constant', line 30, column 3 to column 28)",
                                                      " (in 'constant', line 2, column 5 to column 23)",
                                                      " (in 'constant', line 3, column 14 to column 18)",
                                                      " (in 'constant', line 3, column 5 to column 20)",
                                                      " (in 'constant', line 4, column 16 to column 20)",
                                                      " (in 'constant', line 4, column 5 to column 22)",
                                                      " (in 'constant', line 5, column 13 to column 17)",
                                                      " (in 'constant', line 5, column 5 to column 19)",
                                                      " (in 'constant', line 6, column 5 to column 23)",
                                                      " (in 'constant', line 7, column 12 to column 16)",
                                                      " (in 'constant', line 7, column 18 to column 22)",
                                                      " (in 'constant', line 7, column 5 to column 38)",
                                                      " (in 'constant', line 13, column 9 to column 13)",
                                                      " (in 'constant', line 14, column 24 to column 28)",
                                                      " (in 'constant', line 15, column 13 to column 17)",
                                                      " (in 'constant', line 33, column 9 to column 13)",
                                                      " (in 'constant', line 34, column 9 to column 13)",
                                                      " (in 'constant', line 35, column 9 to column 13)"};
#include <stan_meta_header.hpp>
class model_constant final : public model_base_crtp<model_constant> {
private:
  int Nobs;
  std::vector<int> Npos;
...
public:
  ...
  inline std::string model_name() const final { return "model_constant"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_constant(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_constant_namespace::model_constant";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_constant_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (jacobian__) {
        current_statement__ = 1;
        lambda0 = stan::math::lub_constrain(lambda0, 0, 2, lp__);
      } else {
        current_statement__ = 1;
        lambda0 = stan::math::lub_constrain(lambda0, 0, 2);
      }
      ...
      for (int j = 1; j <= Ymax; ++j) {
        ...
        assign(foi, cons_list(index_uni(j), nil_index_list()), lambda0,
          ...
          "assigning variable P");}
      {
        ...
        lp_accum__.add(uniform_lpdf<propto__>(lambda0, 0, 2));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_constant_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      current_statement__ = 1;
      lambda0_free__ = stan::math::lub_free(lambda0, 0, 2);
...
using stan_model = model_constant_namespace::model_constant;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_constant_namespace::profiles__;
}
#endif
#endif
