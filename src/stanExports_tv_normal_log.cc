...
#include "stanExports_tv_normal_log.h"

RCPP_MODULE(stan_fit4tv_normal_log_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_tv_normal_log")
