...
The `run_seromodel` function allows specifying the Bayesian model from *R*,
...
For each model, the plot_seromodel function generate a vertical arrange of
...
```{r plot_seromodel, include = FALSE, echo = TRUE, errors = FALSE, warning = FALSE, message = FALSE, fig.height=12, fig.width=6}

plot_seromodel(model_2, size_text = 15)
```
...
p1 <- plot_seromodel(model_1, size_text = 15)
p2 <- plot_seromodel(model_2, size_text = 15)
p3 <- plot_seromodel(model_3, size_text = 15)

plot_seromodels_grid(p1, p2, p3, n_row = 1, n_col = 3)
```
