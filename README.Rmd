...
## *serofoi* Estimate the Force-of-Infection from population based serosurveys with  age-disagregated data <img src="man/figures/serofoi-logo.png" align="right" width="130"/>
...
_serofoi_ is an R package to estimates the *Force-of-Infection* of a given pathogen
from age-disaggregated population based sero-prevalence studies, using a
Bayesian framework from [`rstan`](https://mc-stan.org/users/interfaces/rstan)..
...
```{r plot_model, include = TRUE, errors = FALSE, warning = FALSE, message = FALSE}
