...
extract_and_save <- function(res_file_1,
  ...
  foi_cent_est <- rbind(foi_cent_est1)
  ...
  prevalence_expanded <- rbind(prev1)
...
# --- save_best_model
# res_file_2, res_file_3,
# best_model_2, best_model_3,
...
#, foi_1_post_1000s, foi_2_post_1000s
