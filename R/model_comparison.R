...
#'
#' This method relies in the function [rhat][bayesplot::rhat] to extract the R-hat estimates of the serological model object
#' `seromodel_object` and returns a table a dataframe with the estimates for each year of birth.
